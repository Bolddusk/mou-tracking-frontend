...
**Role:** `party_a` only (edit). Sector list readable by any logged-in user.
...
- Super Admin read-only view of Party A profiles is **not** in this step — can be added later.
